...
database_name = case Padrino.env
  when :development then 'learn_to_game_dev_development'
  when :production  then 'learn_to_game_dev_production'
  when :test        then 'learn_to_game_dev_test'
end
...
#     sessions:
#       default:
#         database: learn_to_game_dev_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: learn_to_game_dev_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: learn_to_game_dev_test
#         hosts:
#           - localhost:27017
#
#
